...
class EmailLinks {
    ...
    constructor(client, email_templates) {
         ...
         * @returns {Promise<*>}
         */
        this.send = async (email, redirect, create, additionalPayload, clientInfo, passkeySignUp = false, requestID = null) => {
            if (!email) {
         ...
         * @returns {Promise<*>}
         */
        this.validate = async (emailLinkID, token, requestID = null) => {
            if (!emailLinkID) {
...
exports.default = EmailLinks;
//# sourceMappingURL=emaillinks.service.js.map
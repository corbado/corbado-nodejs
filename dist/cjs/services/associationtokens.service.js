...
var AssociationTokens = /*#__PURE__*/function () {
  /**
   *
   * @param client
   */
  function AssociationTokens(client) {
    _classCallCheck(this, AssociationTokens);
   ...
   * @returns {Promise<*>}
   */
  _createClass(AssociationTokens, [{
    key: "create",
    value: function () {
      var _create = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(loginIdentifier, loginIdentifierType, clientInfo) {
        var requestID,
          params,
          _args = arguments;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              _context.next = 9;
              return _classPrivateFieldGet(this, _client).request('/associationTokens', 'POST', params);
            case 9:
...
var _default = AssociationTokens;
